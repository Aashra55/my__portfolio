    ...
    <div className={font.className}>
      ...
      <div className="flex flex-col justify-center items-center gap-[7px]">
        ...
        <ul className="flex justify-left gap-[10px] items-center mt-[12px] lg:w-[55%] w-[95%] md:w-[100%]">
          <li className="lg:p-[10px] p-[8px] lg:pr-[20px] lg:pl-[20px] border-yellow-300 border-2 rounded-2xl lg:mr-[14px] lg:w-[180px] w-[140px] text-[14px] lg:text-[17px]  md:pl-[10px] md:pr-[10px] md:w-[160px] md:ml-[10px] text-center
          hover:bg-yellow-300 hover:text-black transition-color duration-300 cursor-pointer">Download CV <FontAwesomeIcon icon={faArrowDown}></FontAwesomeIcon></li>
      ...
      <Image src={myimage} alt="" className="shadow-lg hover:shadow-[0_0_10px_4px_rgba(252,211,77,0.7)] transition-shadow duration-300
